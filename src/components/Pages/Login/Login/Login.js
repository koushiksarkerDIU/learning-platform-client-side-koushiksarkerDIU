    ...
    return (
        <div className="w-2/4 mx-auto p-8 space-y-3 rounded-xl bg-gray-100 dark:text-gray-100">
            ...
            <form className="space-y-6 ng-untouched ng-pristine ng-valid">
                ...
                <button className="block w-1/4 mx-auto p-3 text-center rounded-lg dark:text-gray-900 bg-blue-300">Sign in</button>
            </form>
            ...
            <p className="text-xs text-center sm:px-6 dark:text-gray-400">Don't have an account?
                <Link to='/register' className="underline dark:text-gray-100"> Registration</Link>
            </p>
        </div>
    );
};
