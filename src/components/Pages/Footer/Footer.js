...
const Footer = () => {
    return (
        <footer className="px-4 mt-10 divide-y bg-blue-500 text-white">
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                <div className="lg:w-1/3">
                    <Link className="flex justify-center space-x-3 lg:justify-start">
                        ...
                        <span className="self-center text-2xl font-semibold">Mr School</span>
                    </Link>
                </div>
            ...
            <div className="py-6 text-sm text-center dark:text-gray-400">©KoushiK Co. All rights reserved.</div>
        </footer>
    );
};
